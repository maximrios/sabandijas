...
class Pdf extends TCPDF {
	...
	function __construct() {
		...
		$this->print_header = $ci->config->item('header_on');
		if(config_item('header_on') == TRUE) {
    ...
    public function Header() {
        ...
        if($this->page_orientation == 'P') {
        	$this->Image($this->imagen, 19, 3, 50, '', 'JPG', '', 'T', true, 300, '', false, false, 0, false, false, false);	
        }
        else {
